...
# Using 127.0.0.1 to avoid Windows "localhost" IPv6 issues
...
def load_data():
    ...
    # Keep the ID map for Synonyms/ATC which DO use IDs
    ...
    #LOAD ATC CODES (Uses ID Mapping)
    ...
    #LOAD INTERACTIONS (Uses NAME Mapping)
